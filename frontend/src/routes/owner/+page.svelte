...
{:else if stats}
	...
	<section class="card">
		...
		<div class="grid">
			...
			<div class="stat">
				<span class="num digits">{stats.emailReachable}</span>
				<span class="lbl">Email reachable</span>
				<span class="hint">verified + email on</span>
			</div>
			<div class="stat">
				<span class="num digits">{stats.emailOptedOut}</span>
				<span class="lbl">Email opted out</span>
				<span class="hint">master email off</span>
			</div>
			<div class="stat">
				<span class="num digits">{stats.unverified}</span>
				<span class="lbl">Unverified</span>
				<span class="hint">never verified their address</span>
			</div>
		</div>
	</section>
{/if}
